...
config.bind("k", "jseval -q window.scrollBy({top: -60, left: 0, behavior: 'smooth'});")
config.bind("j", "jseval -q window.scrollBy({top: 60, left: 0, behavior: 'smooth'});")
config.bind("h", "jseval -q window.scrollBy({top: 300, left: 0, behavior: 'smooth'});")
config.bind("l", "jseval -q window.scrollBy({top: -300, left: 0, behavior: 'smooth'});")
